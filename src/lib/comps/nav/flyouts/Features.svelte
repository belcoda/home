		...
		<div class="w-screen max-w-md flex-auto overflow-hidden rounded-3xl">
			<div class="p-4">
				...
				<div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
					...
					<div>
						<a href="/features/whatsapp" class="font-semibold text-gray-900">
							WhatsApp
							<span class="absolute inset-0"></span>
						</a>
						<p class="mt-1 text-gray-600">
							Reach people where they are. It's a two-way conversation.
						</p>
					</div>
				</div>
				<div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
				...
				<div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
					...
					<div>
						...
						<p class="mt-1 text-gray-600">
							Bring new people in and deepen engagement with petitions & more
						</p>
					</div>
				</div>
				<div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50">
